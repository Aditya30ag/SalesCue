  ...
  const plans = [
    {
      name: "Individual",
      description:
        "For the solo sales warrior—get instant cues and personalized insights.",
    ...
    },
    {
      name: "Team",
      description:
        "Scale your team's success with advanced features and integrated CRM support.",
      ...
      <section className="relative overflow-hidden py-24">
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          ...
          >
            ...
            <p className="text-xl text-gray-700 dark:text-gray-900 mb-8">
              ...
              <motion.div
                ...
                className={`relative rounded-2xl backdrop-blur-sm overflow-hidden ${
                  plan.popular
                    ...
                    : "bg-white dark:bg-gray-200 border border-gray-100 dark:border-gray-700 shadow-lg"
                }`}
              >
                {plan.popular && (
      ...
      <section className="py-16 bg-gradient-to-r from-blue-600 to-purple-600 text-white">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg mb-6">
            Get sales tips, feature updates, and exclusive insights directly to
            your inbox.
          </p>
